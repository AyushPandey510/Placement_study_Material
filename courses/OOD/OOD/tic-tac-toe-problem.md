...
course: "OOD"
topic: "OOD"
source: "/home/ayush/OOD-Design-Principles/Tic_Tac_Toe-problemTechnical_Interview_Prep.html"
---
...
**Candidate:** Does the game support different board sizes? **Interviewer:** No, let’s stick to the standard 3x3 board for simplicity.
...
- The system determines the game’s status: a win (three identical symbols aligned in a row, column, or diagonal) a draw (a full board with no winner) In progress.

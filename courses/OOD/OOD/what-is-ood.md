---
title: "How Is This Book Structured?"
course: "OOD"
topic: "OOD"
source: "/home/ayush/OOD-Design-Principles/What_is_OOD___Technical_Interview_Prep.html"
---
...
![Image represents a whiteboard on a tripod stand with three rectangular buttons stacked vertically.  Each button contains a design prompt: 'Design a Parking Lot,' 'Design a Vending Machine,' and 'Design Tic-Tac-Toe Game.' A simple cartoon drawing of a girl with black hair, wearing a white shirt and grey pants, stands to the right of the whiteboard, pointing with a stick at the bottom button, 'Design Tic-Tac-Toe Game,' suggesting a focus or selection of this particular design challenge.  There is no explicit information flow depicted; the image simply presents the design prompts and a person seemingly choosing one. The overall style is minimalist and cartoonish.](/assets/images/ood/ood/83894191e6c4176e.webp)
